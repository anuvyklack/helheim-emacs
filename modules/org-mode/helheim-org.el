;;; helheim-org.el -*- lexical-binding: t -*-
;;; Commentary:
;;; Code:
(require 'hel-core)
...
;;       '(("TODO" . (:weight bold)) ;; :foreground "#ff5555"
;;         ("DONE" . (:weight bold)) ;; :foreground "#50fa7b"
;;         ("IN-PROGRESS" . (:foreground "#ffb86c" :weight bold))
;;         ("WAITING" . (:foreground "#f1fa8c" :weight bold))
;;         ("SOMEDAY" . (:foreground "#8be9fd" :weight bold))
...
;;   :init
;;   (setopt org-supertag-sync-directories (list org-directory)))
