...
(defvar helheim-root-directory (file-name-directory load-file-name)
  "The root directory of Helheim core files.
...
;; Load "custom.el" file.
;; (add-hook 'elpaca-after-init-hook (lambda () (helheim-load-file custom-file)))
(add-hook 'after-init-hook (lambda () (helheim-load-file custom-file)))
