;;; helheim-emacs.el --- defaults for text editing -*- lexical-binding: t; -*-
;;; Commentary:
;;; Code:
(require 'dash)
...
;; You may enable you you customizations imediatly without restarting Emacs
;; place the cursor right after the closing bracket and evaluate the form with
...
;;; .
(provide 'helheim-emacs)
;;; helheim-emacs.el ends here
